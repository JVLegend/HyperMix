...
| Bandas, T7c | top-3 menos todas as bandas | AUC espacial -0,036 [-0,092, -0,000] | três bandas não bastaram |
| Transferência, T9 | família física menos alvo laboratorial | AUC -0,191 [-0,217, -0,171]; Pd -0,257 [-0,293, -0,221] | critério primário falhou |
| Alvo retido, T10 | MLP familiar menos MF familiar | AUC -0,014 [-0,033, -0,000]; Pd -0,042 [-0,086, -0,004] | aprendizado pior |
| Limite, T11 | LOD em FAR 1e-2 | nominal entre 15% e 20% | resultado do simulador |
